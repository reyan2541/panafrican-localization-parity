...
\begin{tabular}{@{}p{2.35cm}p{2.15cm}p{2.05cm}p{1.75cm}p{1.55cm}@{}}
\toprule
Study & Measured & Coverage & Confounders & Mitigation \\
\midrule
Wilson et~al.~\cite{wilson2019predictive}
  & AP & 1 dataset & partial & none \\
Brandao~\cite{brandao2019age}
  & miss rate & 1 dataset, 24 dets. & none & none \\
Li et~al.~\cite{li2025bias}
  & miss rate & several, 8 dets. & none & none \\
ICON$^2$~\cite{sudhakar2023icon2}
  & AP & 1 dataset & scale / occ. & none \\
Khoshkdahan et~al.~\cite{khoshkdahan2025pose}
  & detection accuracy & 1 dataset & pose / occ. & none \\
\midrule
\textbf{This work}
  & \textbf{mean IoU (LP)} & \textbf{4 datasets, 3 dets.} & \textbf{ICON$^2$ scale} & \textbf{DWBBR} \\
\bottomrule
\end{tabular}
\end{table}
