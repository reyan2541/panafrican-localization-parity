...
% Springer LNCS / CCIS (llncs.cls) --- official template settings only
...
\begin{document}
% Avoid ugly vertical stretching in the text block (Springer-safe)
\raggedbottom

\title{Beyond Detection Parity: Localization Parity in Pedestrian Detection}
% Required by LNCS when using runningheads (odd page = title, even page = authors)
